...
const options = [
    {
        ...
        label: (
            <div className={styles.dropDown}>
                <span className={styles.selectTitle}>Ethereum</span>
...
const EthSend = ({ showEth, setShowEth }) => {
                ...
                <Modal.Body>
                    {
                        ...
                        <div className={styles.firstwrap}>
                            ...
                            <div className={styles.content}>
                                <span className={styles.title}>Available  0 ETH</span>
                                ...
                                <textarea className={styles.address} type="text" placeholder='To Ethereum Address'></textarea>
                    ...
                    }
                    {
                        ...
                        <div className={styles.forthwrap}>
                            ...
                            <div className={styles.btnContainer}>
                                ...
                                <button onClick={() => setShowEth(false) || setPopup(1)} className={styles.btnActive}>Back to wallet</button>
                            </div>
                        </div>
                    }
                </Modal.Body>
