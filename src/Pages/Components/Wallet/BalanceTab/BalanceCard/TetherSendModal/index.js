...
const options = [
    {
        ...
        label: (
            <div className={styles.dropDown}>
                <span className={styles.selectTitle}>Tether</span>
                <span className={styles.selectTxt}>USDT </span>
            </div>
        ),
    },
    {
...
const TetherSend = ({ showTether, setShowTether }) => {
                ...
                <Modal.Body>
                    {
                        ...
                        <div className={styles.firstwrap}>
                            <img
                                ...
                                src={crossIcon}
                                onClick={() => setShowTether(false)}
                                alt="crossIcon"
                            />
                            <div className={styles.heading}>Send from XYZ Wallet</div>
                            <div className={styles.content}>
                                <span className={styles.title}>Available  0 USDT</span>
                                <div className={styles.alignment}>
                                    <div className={styles.field2}>
                                        <input type="number" placeholder='Tether Amount' />
                                ...
                                <textarea className={styles.address} type="text" placeholder='To Tether Address'></textarea>
                                <p className={styles.infoTxt}>Use a TRC20 or ERC20 wallet addresss. learn more about this a wallet Types.</p>
                                <div className={styles.outSpace}>
                                    <span className={styles.title}>Network</span>
                                    <div className={styles.alignment}>
                                        <div className={styles.setAlign}>
                                            <h3>Tron (TRC-20)</h3>
                                            <p className={styles.infoTxt}>Enter amount and address
                                                to see fees</p>
                                        </div>
                                        <div className={styles.setAlign}>
                    ...
                    }
                    {
                        ...
                        <div className={styles.forthwrap}>
                            ...
                            <div className={styles.btnContainer}>
                                ...
                                <button onClick={() => setShowTether(false) || setPopup(1)} className={styles.btnActive}>Back to wallet</button>
                            </div>
                        </div>
                    }
                </Modal.Body>
